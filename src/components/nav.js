    ...
    return(
        <>
            <main className="w-full min-h-[10vh] flex justify-center md:justify-end place-items-end gap-10 pl-20 pr-20 items-center animate-in">
                ...
                <a href={'/login'} onClick={() => setSelected(1)} className="hover:scale-125 text-xl font-bold text-green-600 md:brightness-150 md:drop-shadow-[0_4px_4px_rgba(0,0,0,0.2)]">Login</a>
            </main>
