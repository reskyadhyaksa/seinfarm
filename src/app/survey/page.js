            ...
            <div className="bg-white py-10 px-12 rounded-xl flex flex-col animate-fade">
              ...
              <div className="flex flex-col gap-2">
                  ...
                  <div className="flex flex-row md:self-start self-center  gap-2">
                      ...
                      <input placeholder="" required min={1} max={50} value={ anak } onChange={(e) => setAnak(parseInt(e.target.value))} className="px-[28px] w-20 bg-gray-300 rounded-lg outline-none text-md flex place-items-center"/>
                  ...
                  <div className="flex flex-row md:self-start self-center gap-2">
                      ...
                      <input placeholder="" required value= { dewasa } onChange={(e) => setDewasa(parseInt(e.target.value))} className="px-[28px] w-20 bg-gray-300 rounded-lg outline-none text-md flex place-items-center"/>
